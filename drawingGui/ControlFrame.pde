...
//Section for other buttons  
  ...
  cp5.addButton("Save As*")
    ...
    .setSize(100,30)
    .setPosition(10,590);
  exp = cp5.get(Button.class,"Save As*");
  ...
  public void draw(){
    textFieldArea.setValue(3.0);
    println(textFieldArea.getValue());
    ...
    if(textButton.isPressed()) textButton.setValue(0.6);
