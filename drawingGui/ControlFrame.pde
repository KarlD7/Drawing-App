public class ControlFrame extends PApplet {
  ...
  public ControlFrame(PApplet parentApplet, int wval, int hval, String nameOf,PFont fonts,Boolean isAdult,PImage shape1,PImage shape2,PImage shape3,PImage shape4,PImage shape5) {
    super();   
    parent = parentApplet;
    w=wval;
    h=hval;
...
//Section for brushes  
  ...
  if(!adult) rectButton.setImage(rectImg,Controller.DEFAULT);
  ...
  if(!adult) elliButton.setImage(elliImg,Controller.DEFAULT);
  ...
  if(!adult) triButton.setImage(triImg,Controller.DEFAULT);
  ...
  if(!adult) arcButton.setImage(arcImg,Controller.DEFAULT);
  ...
  if(!adult) lnButton.setImage(lineImg,Controller.DEFAULT);
